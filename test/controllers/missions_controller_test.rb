...
class MissionsControllerTest < ActionController::TestCase
  ...
  test "should create mission" do
    assert_difference('Mission.count') do
      post :create, mission: { Bloknot_id: @mission.Bloknot_id, Challenge: @mission.Challenge, Status: @mission.Status }
    end
  ...
  test "should update mission" do
    patch :update, id: @mission, mission: { Bloknot_id: @mission.Bloknot_id, Challenge: @mission.Challenge, Status: @mission.Status }
    assert_redirected_to mission_path(assigns(:mission))
  end
